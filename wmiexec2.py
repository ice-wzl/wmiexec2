...
+ Collection                                                                               +
---------------------------------------------------------------------------------------------
  loggrab                   - collects Security, RDP Operational, Defender Log 
  ...
  """)
    ...
    def do_loggrab(self, s):
        try:
            self.do_lget("C:\Windows\System32\Winevt\Logs\Security.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\OpenSSH%4Admin.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\Windows PowerShell.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\OpenSSH%4Operational.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\Microsoft-Windows-WMI-Activity%4Operational.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\Microsoft-Windows-WinRM%4Operational.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\Microsoft-Windows-Windows Defender%4Operational.evtx")
            self.do_lget("C:\Windows\System32\Winevt\Logs\Microsoft-Windows-TerminalServices-RemoteConnectionManager%4Operational.evtx" )
        except:
            pass
    ...
    def do_psp(self, s):
        try:
            self.execute_remote('tasklist /svc | findstr /i "MsMpEng.exe || navapsvc.exe || avkwctl.exe || fsav32.exe || mcshield.exe || ntrtscan.exe || avguard.exe || ashServ.exe || avengine.exe || avgemc.exe || tmntsrv.exe || kavfswp.exe || kavtray.exe || avp.exe"')
            if len(self.__outputBuffer.strip('\r\n')) > 0:
